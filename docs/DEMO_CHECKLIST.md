...
1. Instale o arquivo `NightGuide-1.1.3-arm64.apk` no Android ARM64.
...
3. Em **Assets**, baixe `NightGuide-1.1.3-arm64.apk`. O mesmo binário também fica disponível como artefato `NightGuide-Android-APK` na execução correspondente do GitHub Actions.
